...
const ENCRYPTED_REASONING_SUMMARY =
  "Codex is reasoning, but the upstream Responses API exposed this reasoning block only as encrypted content. OmniRoute cannot recover the private reasoning text.";
